...
function AgentForm(){
    ...
    function handleClick(){
        ...
        if(auth.dob !== ''&& auth.address !== ''&& auth.phone !== ''){
            axios.post('https://node-server-jtym-g9yzsxx4g-bharathkumarsaravanan.vercel.app/agent/'+user+'/form', auth)
            .then(response => {
                var url = 'https://node-server-jtym-g9yzsxx4g-bharathkumarsaravanan.vercel.app/agent/'+user+'/form/profile';
