...
function Index(){
    ...
    function rowEnter(){
        axios.post('https://node-server-jtym-g9yzsxx4g-bharathkumarsaravanan.vercel.app/home/superagent/rowcount',row)
    ...
    function limitEnter(){
        axios.post('https://node-server-jtym-g9yzsxx4g-bharathkumarsaravanan.vercel.app/home/superagent/rowcount',limit)
        .then(response => console.log(response.data))
        localStorage.setItem('seat',!JSON.parse(localStorage.getItem('seat')))  
    }
